                ...
                <div className="container max-w-[100%] w-[85%] mx-auto">
                    <div className='flex items-center justify-between'>
                        <div className='flex flex-col gap-5'>
                            ...
                            <button className='w-[249px] hover:bg-white hover:border-1 hover:border-black hover:text-black transition-[300ms] h-[42px] rounded-3xl bg-green-400 text-white'>Заказать демонстрацию</button>
                        </div>
                        <img src={rasm} alt="" />
                    </div>
                </div>
